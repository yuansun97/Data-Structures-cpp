...
// Test scale 2
TEST_CASE("Image scale(10000, 200)1 scales pixel data in a reasonable way", "[weight=1][part=1]") {
  Image img = createRainbowImage();
...
TEST_CASE("Image scale(240, 50)1 scales pixel data in a reasonable way", "[weight=1][part=1]") {
  Image img = createRainbowImage();
